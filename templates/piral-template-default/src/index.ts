...
import { createPiralTemplateFactory, PiralTemplateSource } from '@smapiot/template-utils';

const root = resolve(__dirname, '..');

interface DefaultPiralArgs {
  title: string;
  feedUrl: string;
  agents: boolean;
}

export default createPiralTemplateFactory<DefaultPiralArgs>(root, (_, { agents }) => {
  const sources: Array<PiralTemplateSource> = [
    {
      name: 'backend.js',
